  ...
  <div class="content">
    ...
    <!----2 Columns----->
      ...
      <div class="row pt-4">
        ...
        ?>
              <div class="column left" style="background-color: rgb(255, 255, 255); width: 52%; margin-bottom: 500px;">
                        ...
                        <div class='btn-group mb-2'>
                          ...
                          <div class='wrapper' style='height: 30px; width: 120px; margin-top: 50px; margin-left: 20px;
                             ...
                             <input type="checkbox" name="code_checkboxes" class="checkCode" checked="checked" value='<?= $check_Items['item_code'] ?>' style="opacity: 0;">
                                <input type="checkbox" name="quan_checkboxes" class="checkQuantity" checked="checked" value='<?= $check_Items['quantity'] ?>' style="opacity: 0;">
                                <input type="checkbox" name="id_checkboxes" class="checkId" checked="checked" value='<?= $check_Items['item_id'] ?>' style="opacity: 0;">
                                <input type="checkbox" name="size_checkboxes" class="checkSize" checked="checked" value='<?= $check_Items['size'] ?>' style="opacity: 0;">
                ...
                ?>
                      ...
                      <div class='card check_item_data shadow-lg mb-1 bg-white rounded' style='height: 130px; background-color: #F0F0F0;'>
                        <div class='btn-group mb-2'>
                          ...
                          <div class='wrapper' style='height: 30px; width: 120px; margin-top: 50px; margin-left: 20px;
                                      text-align: center; justify-content: center; display: flex;'>
                                <input type="checkbox" name="code_checkboxes" class="checkCode" checked="checked" value='<?= $check_Items['check_code'] ?>' style="opacity: 0;">
                                <input type="checkbox" name="quan_checkboxes" class="checkQuantity" checked="checked" value='<?= $check_Items['check_quantity'] ?>' style="opacity: 0;">
                                <input type="checkbox" name="id_checkboxes" class="checkId" checked="checked" value='<?= $check_Items['check_id'] ?>' style="opacity: 0;">
                                <input type="checkbox" name="size_checkboxes" class="checkSize" checked="checked" value='<?= $check_Items['check_size'] ?>' style="opacity: 0;">
                          ...
                          <td class="text-end fs-5 pt-2" style="padding-right: 15px; padding-right: 40px;">₱<?php
                                                                                                            ...
                                                                                                            if (!isset($_GET['checkout'])) {
                                                                                                               while($row = mysqli_fetch_array($resultTotalPricewithSF)){
                                                                                                                    $totalprice = $row['SUM(item_price * quantity)'] + 45;
                                                                                                                    echo $totalprice;
                                                                                   
                                                                                                                }
                                                                                                            } else {
                                                                                                              $totalPrice = $check_Items['check_price'] * $check_Items['check_quantity'] + 45;
                                                                                                              echo $totalPrice;                                                                                                      
                                                                                                            }
                                                                                                            ?>.00</td>
