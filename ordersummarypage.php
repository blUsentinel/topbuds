        ...
        <!-- <form action="includes/checkout.inc.php" method="POST"> -->
         ...
         <h3 class="fw-light pt-2 ps-3 fs-2 pb-2 bg-warning text-start">Items</h3>
              <?php 
                    ...
                    // echo "<h1>$method : $item_code : $size : $qty : $email_add : $item_name : $item_image : $item_price</h1>";
                      ?>
                              <div class='card check_item_data shadow-lg mb-1 bg-white rounded' style='height: 130px; background-color: #F0F0F0;'>
                                ...
                                <div class='btn-group mb-2'>
                                  <div class='form-check' style='width: 400px;'>
                                      <input type="hidden" class="checkEmail" value="<?=$email_add?>">
                                      <input type="hidden" class="checkName" value='<?= $item_name?>'>
                                      <input type="hidden" class="checkSize" value='<?= $size ?>'>
                                      <input type="hidden" class="checkImage" value='<?= $item_image ?>'>
                                      <img class='ms-3 mt-3' style='height: 100px; width: 100px; float: left;' src='./admin-interface/item_images/<?= $item_image ?>' alt=''>
                                      <h6 class='fw-bold text-dark pt-3 ps-5' style='margin-left: 80px;'><?= $item_name ?></h6>
                                      <h6 class='fw-bold ps-5' style='margin-left: 80px; color: orangered;'>₱<?= $item_price ?>.00</h6>
                                      <input type="hidden" class="checkPrice" value='<?= $item_price ?>'>
                                  ...
                                  text-align: center; justify-content: center; display: flex;'>
                                        <input type="checkbox" name="code_checkboxes" class="checkCode" checked="checked" value='<?= $item_code ?>' style="opacity: 0;">
                                        <input type="checkbox" name="" class="checkQuantity" value='<?= $qty ?>' style="opacity: 0;">
                                      <?php 
                                          echo "
                                                <p>Quantity: </p>
                                                <p>{$qty}<p>";
                                  ...
                                  <div class='remove'>
                                        <button class="btn btn-warning deleteItem_btn" value='<?= $item_code ?>' style="margin-top: 44px; height: 40px; width: 40px; margin-left: 60px;">
