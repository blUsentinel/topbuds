...
<body>
    <div class="container shadow-lg bg-white" style="margin-top: 50px; width:100%;">
        ...
        <ul class="nav nav-tabs">
            <li class="nav-item">
                <a class="nav-link" href="main_dashboard.php?products">Sales Report</a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="main_dashboard.php?products">Inventory Report</a>
            </li>
            <!-- <li class="nav-item">
    ...
    <div class="row mt-5">
        ...
        <div class="col-2 rounded text-center" style="background-color: silver; height: 170px;">
            <h6 style="color: black; padding-top: 10px;">Daily Sales</h6>
            <?php
            ...
            while ($row = mysqli_fetch_array($result_select_total)) {
                if (is_null($row['SUM(order_total_price)'])) {
                    ...
                    echo "<h2 style='color: orangered; padding-top: 15px;'> ₱$total_rev.00 </h2>";
                }
            }
            ?>
        ...
        <div class="col-7 ms-1 rounded text-center" style="background-color: silver; height: 170px;">
            <h6 style="color: black; padding-top: 10px;">Weekly Sales</h6>
            <?php
            // $select_total = "SELECT SUM(order_total_price) FROM `orders` WHERE payment_status = 'Paid' AND DATE_FORMAT('order_date', '%Y')";
            // $result_select_total = mysqli_query($conn, $select_total);
            // $number_total = mysqli_num_rows($result_select_total);
        ...
        <div class="rounded col-2 ms-1 text-center" style="background-color: silver; height: 170px;">
            <h6 style="color: black; padding-top: 10px;">Monthly Sales</h6>
            <?php
            $select_total = "SELECT SUM(order_total_price) FROM `orders` WHERE payment_status = 'Paid' AND DATE(`order_date`) = DATE(NOW())";
            $result_select_total = mysqli_query($conn, $select_total);
            // $number_total = mysqli_num_rows($result_select_total);
        ...
        <div class="rounded col-2 ms-1 text-center" style="background-color: silver; height: 170px;">
            <h6 style="color: black; padding-top: 10px;">Yearly Sales</h6>
            <?php
            $select_total = "SELECT SUM(order_total_price) FROM `orders` WHERE payment_status = 'Paid' AND DATE(`order_date`) = DATE(NOW())";
            $result_select_total = mysqli_query($conn, $select_total);
            // $number_total = mysqli_num_rows($result_select_total);
            ...
            <div class="sales">
                ...
                $select = "SELECT DATE_FORMAT('2009-10-04 22:23:00', '%Y')";
                ...
                <div class="row text-center ms-5">
                    <div class="col-3 me-1 border border-primary" style="height: 9rem">
                        <h6 class="fs-6 fw-light mt-3">Count of all products</h6>

                        <h3 class="mt-4">2503 products</h3>
                    </div>
                    <div class="col-3 me-1 border border-primary" style="height: 9rem">
                        <h6 class="mt-3 fw-light">Products out of stock</h6>

                        <h3 class="mt-4">173 products</h3>
                    </div>
                    <div class="col-3 me-1 border border-primary" style="height: 9rem">
                        <h6 class="mt-3 fw-light">Products available</h6>

                        <h3 class="mt-4">701 products</h3>
                    </div>
                </div>
    ...
    <div class="sales">
        ...
        <div class="list-of-products">
            ...
            <select class="form-select" name="range_change"
            ...
            <table class="table table-bordered border-primary table-success mt-2">
                ...
                while ($row = mysqli_fetch_assoc($select_list)) {
                    ...
                    <tr style="font-size: 14px;">
                        ...
                        <td class="text-center">
                            <button type="button" name="paidBtn" id="paidBtn" value="<?php echo $row["order_item_code"] ?>"
    ...
    <!-- <script>
        $(document).ready(function() {
            $('select[name="range_change"]').change(function() {
            var range = $(this).val();
