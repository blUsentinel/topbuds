...
<body>
    <h1 class="ms-1">Admin - Dashboard</h1>
    
    <div class="row">
        <div class="col-md-10 border border-primary bg-light">
            <h4 class="pt-2 ps-2 pb-4">Top Selling</h4>
            <canvas id="topSelling" class="pb-4 ps-5 pe-5"></canvas>
        </div>

        

        <div class="col-md-12">
            <h4 class="pt-5 ps-3">Operational Data</h4>
            <br>
                <div class="row">
                    <div class="col-md-4">
                        <div class="card">
    ...
    <div class="row">
        <div class="col-md-6 pt-5">
            <h4 class="ps-4 pt-2 pb-3">Monthly Sales</h4>
            <canvas class="ps-2" id="monthlySales"></canvas>
        </div>
        <div class="col-md-1"></div>
        <div class="col-md-3 pt-5" style="margin-bottom: 300px;">
                ...
                new Chart(topSelling, {
                    ...
                    data: {
                        ...
                        datasets: [{
                            data: itemSold,
                            borderWidth: 1,
                            backgroundColor: 'rgba(249, 117, 0, 1)'
                        }]
                    },
                    options: {
                        scales: {
