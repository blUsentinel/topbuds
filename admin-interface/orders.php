...
<body>
    ...
    <div class="list-of-products">
        ...
        <table class="table table-bordered border-primary table-success">
            ...
            ?>
            <?php
                $pagLink = "<ul class='pagination d-flex justify-content-end mt-3'>";
                //display the link of the pages in URL  
                for($page = 1; $page<= $number_of_page; $page++) {  
                    $pagLink .= "<li class='page-item'><a class='page-link bg-warning text-dark' href='orders.php?page=".$page."'>".$page."</a></li>";
                }   
                echo $pagLink . "</ul>";  
            ?>
        </table>
